...
const unsigned short tabel[256] = {
...
unsigned short CAgvCheckSum::GetCrc16(const unsigned char *data, unsigned short len, unsigned short pwd)
{
    unsigned short i;
...
int CAgvCheckSum::GetSha1(const char *file, string *sha1Code)
{
    sha1wrapper *mySha1 = new sha1wrapper();

    try
    {
        *sha1Code =  mySha1->getHashFromFile(file);
